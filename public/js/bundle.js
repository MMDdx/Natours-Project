...
var signUp = exports.signUp = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(name, email, password, passwordCon) {
    var res;
...
exports.updateSettings = exports.submitReview = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          if (type === "data") url = 'http://127.0.0.1:8000/api/v1/users/updateMe';else if (type === 'password') url = 'http://127.0.0.1:8000/api/v1/users/updatePassword';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
...
var submitReview = exports.submitReview = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(review, range, id) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: "http://127.0.0.1:8000/api/v1/tours/".concat(id, "/reviews"),
            data: {
              review: review,
              rating: range * 1
            }
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)("success", "Submitted successfully!");
          }
          _context2.next = 11;
          break;
        case 7:
          _context2.prev = 7;
          _context2.t0 = _context2["catch"](0);
          (0, _alerts.showAlert)("error", _context2.t0.response);
  ...
  return function submitReview(_x3, _x4, _x5) {
    return _ref2.apply(this, arguments);
  };
}();
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          stripe = Stripe("pk_test_51QpbOk6lMTPDR3BwVQSf9MoilZJoAlsWGQkPqCd3x5UO65ijFAcUnXklw72W39mihA35ByMiOVz3oRMiiiUJMJXV00jVwRNs0u");
          _context.next = 4;
...
var showMap = exports.showMap = function showMap(mp, locs) {
  ...
  // Create the map
  var map = new H.Map(mp, defaultLayers.vector.normal.map,
  // You can change map style
  // coordinates[lng, lat]
  {
    center: {
      lat: locs[0].coordinates[1],
      lng: locs[0].coordinates[0]
    },
    zoom: 8
  });
...
var formChangeData = document.querySelector("#form-user-data");
var logOutButt = document.querySelector(".nav__el.nav__el--logout");
var userPasswordForm = document.querySelector("#form-user-password");
var myMap = document.querySelector("#map");
var bookBtn = document.querySelector("#book-tour");
var reviewForm = document.querySelector("#form-user-review");
var likeH = document.querySelector(".like");
// delegation
if (locations) {
...
if (signupForm) {
  signupForm.onsubmit = function (e) {
    ...
    var password = document.querySelector("#password").value;
    var passwordCon = document.querySelector("#confirm-password").value;
    (0, _login.signUp)(name, email, password, passwordCon);
  };
}
if (logOutButt) logOutButt.onclick = _login.logout;
if (formChangeData) {
  formChangeData.onsubmit = function (e) {
    e.preventDefault();
...
if (myMap) {
  (0, _mapBox.showMap)(myMap, locations);
}
if (userPasswordForm) {
  userPasswordForm.onsubmit = /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            password = document.querySelector("#password-current");
            newPassword = document.querySelector("#password");
            newPasswordConfirm = document.querySelector("#password-confirm");
            _context.next = 7;
...
if (reviewForm) {
  reviewForm.onsubmit = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
      var review, range, subBtn;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            e.preventDefault();
            ...
            subBtn = document.querySelector("#review-btn");
            subBtn.value = "Processing...";
            _context2.next = 7;
            return (0, _updateSettings.submitReview)(review.value, range.value, reviewForm.dataset.id);
          case 7:
...
if (likeH) {
  likeH.parentElement.onclick = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(e) {
      var url, tourId, countLike, countedlikes, res, _res;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            url = 'http://127.0.0.1:8000/api/v1/likes/';
            tourId = document.querySelector("#book-tour").dataset.tourId;
            countLike = document.querySelector(".countLike");
            countedlikes = parseInt(countLike.textContent);
            _context3.prev = 4;
